        ...
        public static List<ReferenceTab> GetTabs()
        {
            return new List<ReferenceTab>
            {
                ...
                new ReferenceTab("Pages", new List<ReferenceItem>
                {
                    ...
                    new ReferenceItem("ss [seconds] shuffle | slideshow [seconds] shuffle", "Similar to above, but traverse pages in smart-random order"),
                    new ReferenceItem("ss stop | slideshow stop", "Stop the current slideshow"),
                    new ReferenceItem("ss next | slideshow next", "Advance to the next slide in the current slideshow without stopping the slideshow"),
